...
class DataLoader:
    ...
    def get_available_instruments(self, catalog_path: str = "catalog-data") -> List[str]:
        """
    ...
    def validate_data_exists(
        ...
        """
        data = self.load_instrument_data(instrument_id, start_date, end_date, catalog_path)
