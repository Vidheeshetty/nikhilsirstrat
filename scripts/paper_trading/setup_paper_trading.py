...
def check_strategy_configs():
    ...
    for config_file in strategy_configs:
        if Path(config_file).exists():
            ...
            print(f"  You may need to create this file or disable the strategy")
...
def print_next_steps():
    ...
    print("  python -c \"from src.brokers.zerodha.config import ZerodhaConfig; print('✓ Broker modules working')\"")
    print("")
