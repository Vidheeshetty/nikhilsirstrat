...
class PaperTradingServer:
    ...
    def __init__(self, config_file: str = "config/paper_trading.yaml", *, log_level: str = "info"):
    ...
    def _add_routes(self, app: FastAPI):
        ...
        async def update_config(config_data: dict):
            ...
            try:
                ...
                backup_file = Path(f"{self.config_file}.backup.{datetime.now().strftime('%Y%m%d_%H%M%S')}")
...
<body>
    ...
    def run(self, host: str = "0.0.0.0", port: int = 8000, *, log_level: str = "info"):
        ...
        self.logger.info("Starting Paper Trading Server on %s:%s (log-level=%s)", host, port, log_level)
...
def main():
    ...
    parser.add_argument("--config", default="config/paper_trading.yaml", help="Config file")
