...
class MyNSEStrategyConfigLoader(BacktestConfigLoader):
    ...
    """
    def get_strategy_config(self, instrument_id_override: str = None) -> MyNSEStrategyConfig:
        """
        ...
        filtered_config_data = {k: v for k, v in config_data.items() if k in strategy_keys}
