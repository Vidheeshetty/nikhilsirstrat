...
def test_zero_price_handling():
    ...
    test_cases = [
        {"name": "Valid prices", "bid": 100.0, "ask": 105.0, "expected_valid": True},
        {"name": "Zero bid price", "bid": 0.0, "ask": 105.0, "expected_valid": False},
        {"name": "Zero ask price", "bid": 100.0, "ask": 0.0, "expected_valid": False},
        {"name": "Both zero prices", "bid": 0.0, "ask": 0.0, "expected_valid": False},
        {
    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        print(
            f"  Result: {'✓ PASS' if is_valid == test_case['expected_valid'] else '✗ FAIL'}"
        )
