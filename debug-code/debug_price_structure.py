...
print(f"   Approach 4: All 16 bytes as 8 doubles: {struct.unpack('<dd', first_bid_bytes)}")

# Test 5: Check if the issue is in the conversion script
print("\n5. CHECKING CONVERSION SCRIPT ISSUE:")
print("   The issue might be that Price.from_str() is creating the wrong internal representation.")
