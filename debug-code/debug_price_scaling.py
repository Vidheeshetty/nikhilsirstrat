...
if len(first_bid_bytes) >= 9:
    ...
    print(f"   Approach 1 (8+1): value={value1}, precision={precision1}, decoded={decoded1}")
...
if len(first_bid_bytes) >= 5:
    ...
    print(f"   Approach 2 (4+1): value={value2}, precision={precision2}, decoded={decoded2}")
...
if len(first_bid_bytes) >= 9:
    ...
    print(f"   Approach 5 (big-endian): value={value5}, precision={precision5}, decoded={decoded5}")
...
print("\n6. CONCLUSION:")
print("   The issue is likely in how the Price objects are being created in the conversion script.")
